...
function SecondCol() {
  return (
    <div className='flex flex-col flex-1/3 w-full h-full gap-4'>
        ...
        <div className='flex-[1] bg-[#D4C7B4] p-4 rounded-3xl flex items-center justify-evenly text-4xl'>
          ...
          <Link target="_blank" to="https://www.linkedin.com/in/semihyucekan"> <FaLinkedin /> </Link>
        </div>
    </div>
  )
} 
